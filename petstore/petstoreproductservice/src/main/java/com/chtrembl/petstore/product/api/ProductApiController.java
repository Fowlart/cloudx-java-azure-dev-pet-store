...
import com.chtrembl.petstore.product.data.CategoryRepository;
import com.chtrembl.petstore.product.data.ProductRepository;
import com.chtrembl.petstore.product.data.TagRepository;
...
public class ProductApiController implements ProductApi {
    ...
    public void fillDatabase() {
        ...
        dataPreload.getProducts().stream().map(Product::getCategory).distinct().forEach(this.categoryRepository::save);

        for (Product product : dataPreload.getProducts()) {

            product.getTags().forEach(tag -> {
                tag.setProduct(product);
                tag.setGenerateId(tag.getName() + product.getId());
            });
    ...
    public void conigureThreadForLogging() {
        try {
            this.containerEnvironment.setContainerHostName(InetAddress.getLocalHost().getHostAddress() + "/" + InetAddress.getLocalHost().getHostName());
    ...
    public ResponseEntity<String> info() {
        ...
        ApiUtil.setResponse(request, "application/json", "{ \"service\" : \"product service\", \"version\" : \"" + containerEnvironment.getAppVersion() + "\", \"container\" : \"" + containerEnvironment.getContainerHostName() + "\" }");
    ...
    public ResponseEntity<List<Product>> findProductsByStatus(@NotNull @ApiParam(value = "Status values that need to be considered for filter", required = true, allowableValues = "available, pending, sold") @Valid @RequestParam(value = "status", required = true) List<String> status) {
        ...
        if (acceptType != null && contentType != null && acceptType.contains("application/json") && contentType.contains("application/json")) {
            ProductApiController.log.info(String.format("PetStoreProductService incoming GET request to petstoreproductservice/v2/pet/findProductsByStatus?status=%s", status));
            try {
    ...
    public ResponseEntity<List<Product>> findProductsByTags(@NotNull @ApiParam(value = "Tags to filter by", required = true) @Valid @RequestParam(value = "tags", required = true) List<String> tags) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<Product>>(objectMapper.readValue("[ {  \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ],  \"name\" : \"toy\",  \"id\" : 0,  \"category\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"tags\" : [ {    \"name\" : \"name\",    \"id\" : 1  }, {    \"name\" : \"name\",    \"id\" : 1  } ],  \"status\" : \"available\"}, {  \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ],  \"name\" : \"toy\",  \"id\" : 0,  \"category\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"tags\" : [ {    \"name\" : \"name\",    \"id\" : 1  }, {    \"name\" : \"name\",    \"id\" : 1  } ],  \"status\" : \"available\"} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<List<Product>>(objectMapper.readValue("<Product>  <id>123456789</id>  <name>toy</name>  <photoUrls>    <photoUrls>aeiou</photoUrls>  </photoUrls>  <tags>  </tags>  <status>aeiou</status></Product>", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
    ...
    public ResponseEntity<Product> getProductById(@ApiParam(value = "ID of product to return", required = true) @PathVariable("productId") Long productId) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Product>(objectMapper.readValue("{  \"photoUrls\" : [ \"photoUrls\", \"photoUrls\" ],  \"name\" : \"toy\",  \"id\" : 0,  \"category\" : {    \"name\" : \"name\",    \"id\" : 6  },  \"tags\" : [ {    \"name\" : \"name\",    \"id\" : 1  }, {    \"name\" : \"name\",    \"id\" : 1  } ],  \"status\" : \"available\"}", Product.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<Product>(objectMapper.readValue("<Product>  <id>123456789</id>  <name>toy</name>  <photoUrls>    <photoUrls>aeiou</photoUrls>  </photoUrls>  <tags>  </tags>  <status>aeiou</status></Product>", Product.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/xml", e);
                return new ResponseEntity<Product>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
